        ...
        <Switch>
          ...
          <Route path={`${match.path}`}>
            <PhotosIndexContainer>
              ...
              <p>
                I gravitated toward 35 mm film when I started documenting everything as a teenager, and it's still my preferred medium today. My subject matter normally covers scenes from my travel and daily life with my friends and family.
              </p>
            </PhotosIndexContainer>
          </Route>
        </Switch>
